...
#test hotels
#
def test_construieste_un_hotel():
    jucator = Jucator("George", sold=15000)
    cartier = [
        Teren("Timisoara", judet="Timis"),
        Teren("Lugoj", judet="Timis"),
    ...
    teren.visit(jucator)
    teren.visit(jucator)
    assert teren.hotel  == 1
    
def test_construieste_hoteluri():
    jucator = Jucator("George", sold=15000)
    cartier = [
        Teren("Timisoara", judet="Timis"),
        Teren("Lugoj", judet="Timis"),
    ...
    teren.visit(jucator)
    teren.visit(jucator)
    teren.visit(jucator) #max case
    teren.visit(jucator)
    teren.visit(jucator)
    teren.visit(jucator)
    assert teren.hotel  == 3


def test_lipsa_fonduri_construire_hotel():
    jucator = Jucator("George", sold=1651)
    cartier = [
        Teren("Timisoara", judet="Timis"),
        Teren("Lugoj", judet="Timis"),
        Teren("Faget", judet="Timis")
    ...
    teren.visit(jucator)
    teren.visit(jucator)
    assert teren.hotel  == 0


def test_chiria_creste_cu_un_hotel():
    jucator = Jucator("George", sold=15000)
    cartier = [
        Teren("Timisoara", judet="Timis"),
        Teren("Lugoj", judet="Timis"),
    ...
    for teren in cartier:
        teren.visit(jucator)
    teren.visit(jucator)
    teren.visit(jucator)#chirie casa 200
    teren.visit(jucator)#chirie casa 300
    teren.visit(jucator)#chirie casa 400
    teren.visit(jucator)#chirie hotel 500
    assert teren.chirie == 500
    
def test_chiria_creste_cu_multe_hoteluri():
    jucator = Jucator("George", sold=15000)
    cartier = [
        Teren("Timisoara", judet="Timis"),
        Teren("Lugoj", judet="Timis"),
    ...
    teren.visit(jucator)
    teren.visit(jucator)
    assert teren.chirie == 700
    
    
#
#test inchisoare
#
# def test_intra_in_inchisoare():
#     jucator = Jucator("George")
#     masa = [
#         Start(),
#         Teren("Ceva", judet="Cluj"), 
#         Teren("Altceva",  judet="Cluj"), 
#         Teren("1",  judet="Cluj"),
#         Inchisoare()
#     ]
#     #masa = range(5)
#     pozitie = pozitie_finala(masa, jucator, 4)
#     assert jucator.visit(Inchisoare)